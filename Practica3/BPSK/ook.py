...
class ook(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fc_range = qtgui.Range(Rb, samp_rate/8, Rb, Rb*3, 200)
        ...
        self.connect((self.blocks_multiply_const_vxx_1, 0), (self.epy_block_0, 1))
        self.connect((self.blocks_multiply_const_vxx_1, 0), (self.epy_block_0_0, 1))
